                ...
                <div class="col-lg-8 mb-4 col-md-6 mx-auto my-5">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Data Status Pegawai</h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('status_pegawai.update', $data->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between pt-3">
                                    <a href="{{ route('status_pegawai.index') }}" class="btn btn-warning">Kembali</a>
