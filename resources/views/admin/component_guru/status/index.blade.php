        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex">
                    <h6 class="m-0 font-weight-bold text-primary">Data Status Pegawai</h6>
                    <div class="ml-auto">
                        <a href="{{ route('status_pegawai.create') }}" class="btn btn-success btn-sm" title="Tambah Data">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('status_pegawai.edit', $dt->id) }}"
                                                ...
                                                <form id="delete-form-{{ $dt->id }}"
                                                    action="{{ route('status_pegawai.destroy', $dt->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
